...
// $("#projects-tooltip-btn").on("shown.bs.tooltip", function(){
//     $(".tooltip").animate({width: "200px"}, 1000);
// });

// $("#projects-tooltip-btn").on("hidden.bs.tooltip", function(){
//     $(".tooltip").animate({width: "toggle"});
// });
